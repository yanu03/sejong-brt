...
public class BM0201Controller extends BaseController{
    ...
    @GetMapping("/BM0201G1S2")
    public Responses.ListResponse BM0201G1S2(RequestParams<VhcDeviceVO> requestParams) {
    	return Responses.ListResponse.of(service.BM0201G1S2(requestParams));
    }
    ...
    public ApiResponse BM0201F0I0(@RequestBody VhcDeviceVO request) {
        String dvcId = service.BM0201F0I0(request);
        return ok(dvcId);
    }
