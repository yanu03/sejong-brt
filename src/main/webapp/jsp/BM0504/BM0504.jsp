...
<ax:layout name="base">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='/assets/js/view/BM0504/BM0504.js' />"></script>
    </jsp:attribute>
    <jsp:body>
                   ...
                   <ax:tr>
        	         <ax:form name="searchView0">
                        <ax:td label='ax.admin.search' width="300px">
                            <ax:input type="text" name="filter" id="filter" clazz="form-control" placeholder="ax.admin.BM0504S0.search"/>
                        </ax:td>
                     </ax:form>
                        <ax:td label='ax.admin.BM0504S0.file' width="300px">
