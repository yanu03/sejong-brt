...
<ax:layout name="base">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='/assets/js/view/AD0104/AD0104.js' />"></script>
    </jsp:attribute>
    <jsp:body>
                ...
                <ax:tbl clazz="ax-search-tbl" minWidth="500px">
                    <ax:tr>
                        <ax:td label='ax.admin.search' width="300px">
                            <ax:input type="text" name="filter" id="filter" clazz="form-control" placeholder="ax.admin.AD0104S0.search"/>
                        </ax:td>
