...
var ACTIONS = axboot.actionExtend(fnObj, {
	...
	PAGE_EXCEL: function(caller, act, data) {
    	caller.gridView0.target.exportExcel("운수사목록_" + new Date().yyyymmdd() + ".xls");
    },
...
fnObj.gridView0 = axboot.viewExtend(axboot.gridView, {
    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                {key: "corpId",	label: ADMIN("ax.admin.BM0101F0.corp.id"),		width: 80,	align: "center",	sortable: true},
                {key: "corpNm",	label: ADMIN("ax.admin.BM0101F0.corp.name"),	width: 120,						sortable: true},
