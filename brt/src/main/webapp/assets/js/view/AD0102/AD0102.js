                    ...
                    axboot.ajax({
                        ...
                        options: {
                        	onError: function(err) {
                        		axDialog.alert("동일한 구분, 광고등급, 부착위치는 1가지만 추가 가능합니다.");
                        	}
                        }
                    });
                })
...
fnObj.gridView0 = axboot.viewExtend(axboot.gridView, {
    ...
    selectIdRow: function(id) {
    	...
    	for(i = 0; i < length; i++) {
    		if(this.target.list[i].priceId == id) {
    			this.selectRow(i);
    			break;
    		}
    	}
