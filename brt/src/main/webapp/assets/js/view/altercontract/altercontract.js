    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                ...
                {key: "altDiv", label: "변경구분", width: 80},
                {key: "altCondate", label: "계약변경일", width: 120},
                {key: "conStdate", label: "계약시작일", width: 120},
                {key: "conEddate", label: "계약종료일", width: 120},
                {key: "suppAmt", label: "공급가액", width: 120},
                {key: "vatAmt", label: "부가세", width: 120},
                {key: "remark", label: "비고", width: 70},
                {key: "confirmYn", label: "확정여부", width: 120},
                {key: "conNo", label: "계약번호", width: 70},
                //{key: "remark", label: "비고", width: 70},
            ],
            body: {
                onClick: function () {
