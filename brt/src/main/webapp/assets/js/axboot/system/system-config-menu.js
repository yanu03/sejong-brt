                    ...
                    caller.formView01.authGroup.forEach(function (g) {
                        ...
                        if (res.program) {
                            $.extend(item, {
                                ...
                                program_gexAh: res.program.gexAh || "N",
                                program_exlAh: res.program.exlAh || "N",
                                program_iexAh: res.program.iexAh || "N",
                                ...
                                program_swpAh: res.program.swpAh || "N",
                            });
                        }
                        list.push(item);
                    });
    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                ...
                {key: "swpAh", label: COL("ax.admin.program.auth.swpstop"), 	width: 50, align: "center", editor: "menu-program-auth-checkYn"},
