    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                ...
                {key: "gexAh", label: COL("ax.admin.program.auth.excelform"), width: 50, align: "center", editor: "checkYn"},
                {key: "exlAh", label: COL("ax.admin.program.auth.excel"), width: 50, align: "center", editor: "checkYn"},
                {key: "iexAh", label: COL("ax.admin.program.auth.excelimport"), width: 50, align: "center", editor: "checkYn"},
                ...
                {key: "fn7Ah", label: "FN7", width: 50, align: "center", editor: "checkYn"},
