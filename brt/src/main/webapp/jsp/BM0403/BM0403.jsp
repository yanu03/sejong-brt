                ...
                <div class="ax-button-group" data-fit-height-aside="gridView0">
                    <div class="left">
                        <h2><i class="cqc-list"></i>
                            <ax:lang id="ax.admin.BM0403G0.title"/> </h2>
                    </div>
                    <div class="right">
            ...
            <ax:split-panel width="*" style="padding-left: 10px;" scroll="scroll">
                ...
                <ax:form name="formView0">
                    <ax:tbl clazz="ax-form-tbl" minWidth="500px">
                        <ax:tr>
                            <ax:td label="ax.admin.BM0403F0.voc.id" width="300px" labelClazz="required">
                                <input type="text" name="vocId" data-ax-path="vocId" data-key="true" class="form-control" readonly="readonly"/>
                            </ax:td>
                            <ax:td label="ax.admin.BM0403F0.voc.nm" width="300px" labelClazz="required">
                                <input type="text" name="vocNm" data-ax-path="vocNm" title="<ax:lang id="ax.admin.BM0403F0.voc.nm"/>" class="form-control" data-ax-validate="required" />
                            </ax:td>
                        </ax:tr>
                        
                        <ax:tr>
                            <ax:td label="ax.admin.BM0403F0.play.date" width="400px" labelClazz="required">
	                            <div class="input-group" data-ax5picker="date">
	                                <input type="text" name="playStDate" data-ax-path="playStDate" title="<ax:lang id="ax.admin.BM0403F0.play.date"/>" class="form-control" placeholder="0000-00-00" data-ax5formatter="date" data-ax-validate="required">
	                                <span class="input-group-addon">~</span>
	                                <input type="text" name="playEdDate" data-ax-path="playEdDate" title="<ax:lang id="ax.admin.BM0403F0.play.date"/>" class="form-control" placeholder="0000-00-00" data-ax5formatter="date" data-ax-validate="required">
                        ...
                        <ax:tr>
                       	...
                       	<ax:tr>
                            <ax:td id="wavLabel" label="ax.admin.BM0403F0.wav" width="100%">
                            	<input type="file" id="wavFile" name="wavFile" class="form-control inline-block W180" accept="audio/wav" title="<ax:lang id="ax.admin.BM0403F0.wav"/>"/>
                       	...
                       	<ax:tr>
                            <ax:td id="krTtsLabel" label="ax.admin.BM0403F0.kr.tts" width="100%">
                            	<textarea name="krTts" data-ax-path="krTts" title="<ax:lang id="ax.admin.BM0403F0.kr.tts"/>" class="form-control"></textarea>
						...
						<%--                       	
                       	...
                       	<ax:tr>
                            <ax:td label="ax.admin.BM0403F0.remark" width="300px">
