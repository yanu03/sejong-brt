                ...
                <ax:tbl clazz="ax-search-tbl" minWidth="500px">
                    <ax:tr>
                        <ax:td label='ax.admin.search' width="300px">
                            <ax:input type="text" name="filter" id="filter" clazz="form-control" placeholder="ax.admin.BM0402S0.search"/>
                        </ax:td>
                    </ax:tr>
                </ax:tbl>
            </ax:form>
                ...
                <div class="ax-button-group" data-fit-height-aside="gridView0">
                    <div class="left">
                        <h3><i class="cqc-list"></i>
                            <ax:lang id="ax.admin.BM0402G0.title"/> 
                        </h3>
                    </div>
                    <div class="right">
            ...
            <ax:split-panel width="700" style="padding-left: 10px;" scroll="scroll">
                ...
                <div class="ax-button-group" role="panel-header">
                    <div class="left">
                        <h3><i class="cqc-news"></i>
                            <ax:lang id="ax.admin.BM0402F0.title"/>
                        </h3>
                    </div>
                </div>
                <ax:form name="formView0">
                    <ax:tbl clazz="ax-form-tbl" minWidth="500px">
                        <ax:tr>
                            <ax:td label="ax.admin.BM0402F0.voc.id" width="210px" labelClazz="required">
                                <input type="text" name="vocId" data-ax-path="vocId" data-key="true" class="form-control" readonly="readonly"/>
                            </ax:td>
                            <ax:td label="ax.admin.BM0402F0.voc.nm" width="300px" labelClazz="required" style="border-left: 1px solid #D8D8D8;">
                        ...
                        <ax:tr>
                            <ax:td label="ax.admin.BM0402F0.con.title" width="100%" labelClazz="required">
	                            <div class="input-group">
	                        		<div style="float:left;padding-right:5px;"><input type="text" data-ax-path="conId" name="conId" data-key="true" class="form-control W70" readonly="readonly" title="<ax:lang id="ax.admin.BM0402F0.con.id"/>" data-ax-validate="required"></div>
	                        		<div style="float:left;padding-right:5px;"><input type="text" data-ax-path="conNm" name="conNm" data-key="true" class="form-control W130" readonly="readonly"></div>
                        ...
                        <ax:tr>
                            <ax:td label="ax.admin.BM0402F0.play.date" width="350px" labelClazz="required">
                        ...
                        <ax:tr>
                            <ax:td label="ax.admin.BM0402F0.play.type" width="210px" labelClazz="required">
                       	...
                       	<ax:tr>
                            <ax:td id="wavLabel" label="ax.admin.BM0402F0.wav" width="100%">
                            	<div style="float:left;width:475px;">
                            		<input type="file" id="wavFile" name="wavFile" accept="audio/wav" title="<ax:lang id="ax.admin.BM0401F0.wav"/>"/>
                            	</div>
...
<%--                        	<ax:tr>
 ...
 --%>                       	<ax:tr>
                       	...
                       	<ax:tr>
                            <ax:td label="ax.admin.BM0402F0.remark" width="100%">
