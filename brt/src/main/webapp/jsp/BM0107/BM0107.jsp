    ...
    <jsp:body>
        ...
        <ax:split-layout name="ax1" orientation="vertical">
	        <ax:split-panel width="500">
	            <ax:split-panel width="500" style="height:270px; padding-right: 5px;">
	                <!-- 목록 -->
	                    ...
	                    <ax:tr>
	                        <ax:td label='ax.admin.search' width="500px">
	                        	<div class="input-group" >
		                            <ax:input type="text" name="filter1" id="filter1" placeholder="ax.admin.BM0107S1.search" clazz="inline-block" style="width:180px; margin-right:10px;"/>
