...
<ax:layout name="modal">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='/assets/js/common/BM0304_modal.js'/>"></script>
    </jsp:attribute>
    <jsp:attribute name="header">
        ...
        <div style="position: absolute; top: 15px; right: 430px;">
    ...
    <jsp:body>
        ...
        <ax:split-layout name="ax1" orientation="vertical">
            ...
            <div class="ax-button-group" data-fit-height-aside="gridView01">
                    <div class="left">
                        <h3><i class="cqc-list"></i>
                            <ax:lang id="ax.admin.BM0304M1.title"/>
                        </h3>
                    </div>
                </div>
                <div data-ax5grid="gridview01" data-fit-height-content="gridview01" style="height: 300px;"></div>
            </ax:split-panel>
        </ax:split-layout>
