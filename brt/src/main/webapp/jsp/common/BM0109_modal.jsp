...
<ax:layout name="modal">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='/assets/js/common/BM0109_modal.js' />"></script>
    </jsp:attribute>
                ...
                <ax:tbl clazz="ax-search-tbl" minWidth="500px">
                    <ax:tr>
                        <ax:td label='ax.admin.sample.search.condition' width="300px">
                            <ax:input type="text" name="filter" id="filter" clazz="form-control" placeholder="정류장ID, 정류장명, 정류장번호"/>
                        </ax:td>
                    </ax:tr>
                </ax:tbl>
            </ax:form>
