...
<ax:layout name="base">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value="/assets/js/view/BM0406/BM0406.js"/>"></script>
    </jsp:attribute>
    <jsp:body>
        ...
        <ax:split-layout name="ax1" orientation="vertical">
                ...
                <div class="ax-button-group" data-fit-height-aside="gridView0">
	                    <div class="left">
	                        <h3><i class="cqc-list"></i>
	                            <ax:lang id="ax.admin.BM0406G0.title"/> </h3>
	                    </div>
	                </div>
            ...
            <ax:split-panel width="*" style="padding-left: 10px;" scroll="scroll">
                <div class="ax-button-group" data-fit-height-aside="gridView1">
                    <div class="left">
                        <h3><i class="cqc-list"></i>
                            <ax:lang id="ax.admin.BM0406G1.title"/> </h3>
                    </div>
                </div>
