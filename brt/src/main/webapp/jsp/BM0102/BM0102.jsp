            ...
            <ax:split-panel width="550" style="padding-left: 10px; height:100%; padding-bottom:490px;">
	            <ax:split-panel width="500" style="height:450px;" scroll="scroll">
	                ...
	                <ax:form name="formView0">
						...
						<ax:tbl clazz="ax-form-tbl" minWidth="500px">
	                       	...
	                       	<ax:tr>
	                            <ax:td label="ax.admin.BM0102F0.remark" width="100%">
	            ...
	            <ax:split-panel width="500" style="height:100%;">
	                <div class="ax-button-group" role="panel-header">
	                    ...
	                    <div class="right">
	                    	<button type="button" class="btn btn-default" data-grid-control="row-add"><i class="cqc-circle-with-plus"></i> <ax:lang id="ax.admin.add"/></button>
                        	<button type="button" class="btn btn-default" data-grid-control="row-del"><i class="cqc-circle-with-minus"></i> <ax:lang id="ax.admin.delete"/></button>
	                    </div>
	                </div>
