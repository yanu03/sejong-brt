            ...
            <ax:split-panel width="*" style="padding-left: 10px;" scroll="scroll">
                ...
                <ax:form name="formView0">
                    <ax:tbl clazz="ax-form-tbl" minWidth="500px">
                        ...
                        <ax:tr>
                            <ax:td label="ax.admin.BM0102F0.corp.no" width="300px">
                        ...
                        <ax:tr>
                            <ax:td label="ax.admin.BM0102F0.phone" width="300px">
                            	<input type="text" data-ax-path="phone" class="form-control"/>
                            </ax:td>
                            <ax:td label="ax.admin.BM0102F0.fax" width="300px">
                       	...
                       	<ax:tr>
                            <ax:td label="ax.admin.BM0102F0.addr1" width="300px">
                            	<input type="text" data-ax-path="addr1" class="form-control"/>
                            </ax:td>
                       	</ax:tr>
                       	
                       	<ax:tr>
                       		<ax:td label="ax.admin.BM0102F0.zip.no" width="300px">
                            	<input type="text" data-ax-path="zipNo" class="form-control"/>
                            </ax:td>
                       	</ax:tr>
                       	
                       	<ax:tr>
                            <ax:td label="ax.admin.BM0102F0.addr2" width="300px">
                            	<input type="text" data-ax-path="addr2" class="form-control"/>
                            </ax:td>
                       	</ax:tr>
                       	
                       	<ax:tr>
                            <ax:td label="ax.admin.BM0102F0.remark" width="300px">
